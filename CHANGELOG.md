...
## [NEXT] 
### Added
- A Box for Information on the Homescreen [#216] (https://github.com/h-da/geli/issues/216)
- Possibility to sort all courses alphabetically. [#567](https://github.com/h-da/geli/issues/567)
